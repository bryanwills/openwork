...
export default {
  ...
  "providers.enabled_prefix": "已启用",
  "providers.enable_failed": "启用提供商失败",
  ...
  "settings.provider_disabled_badge": "已断开",
  "settings.provider_disabled_hint": "已从模型和 Connect 提供商中隐藏。",
  "settings.enable_provider": "启用",
  "settings.enabling_provider": "正在启用…",
