...
export default {
  ...
  "composer.plus_label": "Add files, skills, connectors, and more",
  "composer.plus_search_placeholder": "Search files, skills, connectors",
  "composer.plus_search_in": "Search {section}",
  "composer.plus_attach": "Attach a file",
  "composer.plus_recent": "Recent",
  "composer.plus_browse": "Browse",
  "composer.plus_skills": "Skills",
  "composer.plus_connectors": "Connectors",
  "composer.plus_plugins": "Plugins",
  "composer.plus_agents_commands": "Agents and commands",
  "composer.plus_agents": "Agents",
  "composer.plus_commands": "Commands",
  "composer.plus_files": "Files",
  "composer.plus_manage_skills": "Manage skills",
  "composer.plus_manage_connectors": "Manage connectors",
  "composer.plus_manage_plugins": "Manage plugins",
  "composer.plus_manage_agents_commands": "Manage agents and commands",
  "composer.plus_no_matches": "No matches for “{query}”",
  "composer.plus_section_empty": "Nothing here yet",
  "composer.plus_loading": "Loading…",
  "composer.plus_connect": "Connect",
  "composer.plus_connect_named": "Connect {name}",
  "composer.plus_back": "Back",
  "composer.plus_selected": "Selected",
  ...
  "den.cloud_provider_removed_detail": "This imported provider is no longer in cloud. Remove the local {providerId} config.",
  ...
  "extensions.badge_connection": "Connector",
  "extensions.badge_mcp": "Connector",
  ...
  "extensions.add_picker_hint": "Connect the tools your AI works in, or teach it how you work.",
  "extensions.add_picker_make": "WHAT ARE YOU MAKING",
  "extensions.add_picker_connect": "OR CONNECT SOMETHING",
  "extensions.add_picker_footer": "New things start just for you. Share them whenever you like.",
  "extensions.back_to_library": "Back to Library",
  "extensions.add_page_just_me_note": "Only you can use it until you share it.",
  "extensions.add_picker_continue": "Continue",
  "extensions.kind_skill": "Skill",
  "extensions.kind_skill_hint": "Teach the AI how you do a task, in plain words.",
  ...
  "extensions.kind_plugin_hint": "A set of skills, commands and connectors, added in one go.",
  ...
  "extensions.mcp_check_title": "Checking {name}",
  "extensions.mcp_check_hint": "OpenWork looks at the server before adding it. Nothing is saved yet.",
  "extensions.mcp_check_done": "{name} is ready to add",
  "extensions.mcp_check_done_warn": "{name} can be added, with a note",
  "extensions.mcp_check_failed": "{name} can't be added yet",
  "extensions.mcp_check_pending": "Checking…",
  "extensions.mcp_check_reach": "Finds the server",
  "extensions.mcp_check_protocol": "Talks like an MCP server",
  "extensions.mcp_check_sign_in": "Knows how you sign in",
  "extensions.mcp_check_registration": "Lets OpenWork sign you in",
  "extensions.mcp_check_tools": "Has things your AI can do",
  "extensions.mcp_check_reach_ok": "The address answered.",
  "extensions.mcp_check_reach_fail": "Nothing answered at this address. Check it and try again.",
  "extensions.mcp_check_protocol_ok": "It replied as an MCP server.",
  "extensions.mcp_check_protocol_ok_version": "It replied as an MCP server ({version}).",
  "extensions.mcp_check_protocol_fail": "Something answered, but it isn't an MCP server.",
  "extensions.mcp_check_sign_in_oauth": "You sign in with your own account.",
  "extensions.mcp_check_sign_in_none": "No sign-in needed.",
  "extensions.mcp_check_sign_in_key": "It uses a key you paste in.",
  "extensions.mcp_check_sign_in_unknown": "It didn't say how to sign in. You can still try.",
  "extensions.mcp_check_registration_dynamic": "OpenWork registers itself automatically.",
  "extensions.mcp_check_registration_metadata": "OpenWork introduces itself automatically.",
  "extensions.mcp_check_registration_manual": "An admin has to register OpenWork with this service first.",
  "extensions.mcp_check_tools_ready": "{count} tools are ready.",
  "extensions.mcp_check_tools_after_sign_in": "Its tools show up after you sign in.",
  "extensions.mcp_check_tools_none": "It didn't list any tools yet.",
  "extensions.mcp_check_continue": "Continue",
  "extensions.mcp_check_add_anyway": "Add anyway",
  "extensions.mcp_check_edit": "Change address",
  "extensions.mcp_check_unavailable": "OpenWork couldn't check this server. You can still add it.",
  ...
  "extensions.detail_fact_who": "Who can use this",
  ...
  "extensions.detail_who_everyone": "Everyone in {org}",
  "extensions.detail_who_team": "People in {team}",
  "extensions.detail_who_you": "Just you",
  "extensions.kind_connector": "Connector",
  "extensions.kind_connector_hint": "Let the AI work inside Slack, Notion, GitHub, or an MCP of your own.",
  "extensions.add_connector": "Add a connector",
  "extensions.add_skill_name_placeholder": "e.g. Customer briefing",
  "extensions.add_skill_when_label": "When should it be used?",
  "extensions.add_skill_when_required": "Say when the AI should use it.",
  "extensions.add_skill_what_label": "What should it do?",
  "extensions.add_skill_what_required": "Say what it should do.",
  "extensions.add_connector_name_placeholder": "e.g. Team wiki",
  "extensions.add_component_name_label": "{kind} name",
  "extensions.add_component_name_placeholder": "e.g. Prep a sales call",
  "extensions.add_connector_something_else": "Something else",
  "extensions.add_plugin_remove_component": "Remove {kind}",
  "extensions.create_mcp_submit_sign_in": "Add and sign in",
  "extensions.connector_catalog_title": "Add a connector",
  "extensions.connector_catalog_filter": "Filter connectors",
  "extensions.connector_catalog_empty": "No connectors match that name.",
  "extensions.connector_added": "Added",
  "extensions.connector_add": "Add",
  "extensions.connector_add_named": "Add {name}",
  "extensions.connector_something_else_title": "Something else",
  "extensions.connector_something_else_hint": "Add an MCP server with the address your vendor or IT team gave you.",
  "extensions.connector_add_mcp": "Add an MCP",
  "extensions.connector_setup_title": "Set up {name}",
  "extensions.connector_can_do": "What your AI can do",
  "extensions.connector_can_read": "Read {summary} you can already see",
  "extensions.connector_can_act": "Act as you, only when you ask",
  "extensions.connector_note_sign_in": "You sign in with your own {name} next. OpenWork only sees what you can see.",
  "extensions.connector_note_key": "Paste the key your admin or the service gave you. It stays with this connector.",
  "extensions.connector_note_none": "This one needs no sign-in. Anyone you share it with can use it right away.",
  "extensions.connector_note_codes": "{name} asks for two codes from your {name} app first. Then you sign in with your own account.",
  "extensions.connector_codes_required": "Add the client ID from your {name} app.",
  "extensions.connector_sign_in_with": "Sign in with {name}",
  "extensions.page_breadcrumb": "Where you are",
  "extensions.row_menu_label": "More for {name}",
  "extensions.row_menu_open": "Open",
  "extensions.row_menu_edit": "Edit",
  "extensions.row_menu_share": "Share…",
  "extensions.row_menu_duplicate": "Duplicate",
  "extensions.row_menu_stop_sharing": "Stop sharing",
  "extensions.row_menu_delete": "Delete…",
  "extensions.row_chip_sign_in": "Sign in",
  "extensions.row_chip_set_up": "Set up",
  ...
  "extensions.row_owned_shared": "Shared with {audience}",
  "extensions.row_changed_just_now": "Changed just now",
  "extensions.row_changed_just_now_shared": "Changed just now · {audience} has it",
  "extensions.row_provided_by": "Comes with {source}",
  "extensions.row_shared_connection": "Shared with you",
  "extensions.row_skill_fallback": "Installed skill",
  ...
  "extensions.section_mine_just_me": "{count} · only you so far",
  "extensions.section_mine_shared": "{count} shared with {audience}",
  ...
  "extensions.share_who_can_use": "Who can use it",
  "extensions.share_everyone_title": "Everyone in the organization",
  "extensions.share_everyone_on": "On. Everyone in the organization can use it.",
  "extensions.share_everyone_off": "Off. Only you and the people below can use it.",
  "extensions.share_owner_title": "{name} (you)",
  "extensions.share_you": "You",
  "extensions.share_owner_hint": "Can change and delete it",
  "extensions.share_owner_role": "Owner",
  "extensions.share_team_hint": "{count} people, and anyone who joins {team} later",
  "extensions.share_person_hint": "Can use it",
  "extensions.share_remove": "Remove {name}",
  "extensions.share_remove_short": "Remove",
  "extensions.share_add_person": "Add person",
  "extensions.share_add_person_empty": "Everyone already has it.",
  "extensions.share_add_team": "Add team",
  "extensions.share_add_team_empty": "No more teams to add.",
  "extensions.share_gets_skill": "They get the skill as you wrote it. When you change it, they get your changes. Only you can change or delete it.",
  "extensions.share_gets_connector": "They get the connector and sign in with their own account. Only you can change or delete it.",
  "extensions.share_gets_plugin": "They get everything inside, as you set it up. When you change it, they get your changes. Only you can change or delete it.",
  "extensions.share_people_count": "{count} people will have it.",
  "extensions.share_footer_shared": "{audience} will see it in their Library.",
  "extensions.share_footer_stop": "Only you will have it.",
  "extensions.share_footer_just_me": "Only you can use it until you share it.",
  "extensions.share_with": "Share with {audience}",
  "extensions.share_stop": "Stop sharing",
  "extensions.share_unknown_team": "A team",
  "extensions.share_unknown_person": "Someone",
  "extensions.share_audience_everyone": "everyone",
  "extensions.share_audience_just_me": "just you",
  "extensions.share_audience_two": "{first} and {second}",
  "extensions.share_audience_many": "{first} and {count} more",
  "extensions.edit_title": "Edit {name}",
  "extensions.edit_undo_note": "You can undo for a few seconds.",
  "extensions.edit_save_for_everyone": "Save for everyone",
  "extensions.edit_save": "Save",
  "extensions.edit_skill_incomplete": "Fill in all three fields.",
  "extensions.edit_shared_title": "{audience} has this skill ({count} people)",
  "extensions.edit_shared_body": "Saving changes it for them too, in their next task.",
  "extensions.edit_shared_copy_prompt": "Want to try it alone first?",
  "extensions.edit_save_copy": "Save a copy just for me",
  "extensions.duplicate_name": "{name} (copy)",
  "extensions.delete_title": "Delete {name}?",
  "extensions.delete_body_shared": "It leaves your Library and {audience}'s Library ({count} people). Tasks that already used it keep their results.",
  "extensions.delete_body_just_me": "It leaves your Library. Tasks that already used it keep their results.",
  "extensions.delete_stop_prompt": "Only want {audience} to lose it?",
  "extensions.delete_stop_lead": "Keep it for yourself and",
  "extensions.delete_stop_link": "stop sharing instead",
  "extensions.delete_confirm": "Delete",
  "extensions.toast_added_title": "Added to your Library",
  "extensions.toast_added_detail": "Only you can use it for now",
  "extensions.toast_share_action": "Share…",
  "extensions.toast_shared_title": "{name} shared with {audience}",
  "extensions.toast_shared_detail": "{count} people have it in their Library now",
  "extensions.toast_stopped_title": "Stopped sharing {name}",
  "extensions.toast_stopped_detail": "Only you have it now",
  "extensions.toast_saved_title": "{name} saved",
  "extensions.toast_saved_detail": "Your next task uses the new version",
  "extensions.toast_saved_detail_shared": "{audience} gets the new version in their next task",
  "extensions.toast_deleted_title": "{name} deleted",
  "extensions.toast_deleted_detail": "It's gone from your Library",
  "extensions.toast_deleted_detail_shared": "{audience} no longer has it",
  ...
  "extensions.add_mcp_auth_label": "How does it sign in?",
  "extensions.add_mcp_auth_oauth": "With my account",
  "extensions.add_mcp_auth_oauth_hint": "You sign in on the tool’s own page after adding it.",
  "extensions.add_mcp_auth_apikey": "With a key",
  "extensions.add_mcp_auth_apikey_hint": "Paste the key from the tool or your IT team.",
  "extensions.add_mcp_auth_none": "No sign-in",
  "extensions.add_mcp_auth_none_hint": "It works as soon as it is added.",
  ...
  "extensions.empty_mcp_title": "No MCPs yet",
  "extensions.empty_mcp_hint": "Connect a cloud MCP to give your agents access to your tools and services.",
  "extensions.empty_skill_title": "No skills yet",
  "extensions.empty_skill_hint": "Add reusable instructions for work your agents do often.",
  "extensions.empty_plugin_title": "No plugins yet",
  "extensions.empty_plugin_hint": "Add a plugin to bring related skills and MCPs into your Library.",
  "extensions.empty_mcp_ready": "No MCPs ready to use",
  "extensions.empty_skill_ready": "No skills ready to use",
  "extensions.empty_plugin_ready": "No plugins ready to use",
  "extensions.empty_state_title": "No items in this state",
  "extensions.empty_ready_hint": "Your items need attention before they are ready. Choose a status to review the next step.",
  "extensions.clear_filters": "Clear filters",
  "extensions.cloud_unavailable": "OpenWork Cloud is unavailable. Refresh to try again.",
  "extensions.cloud_library_title": "Your Cloud Library",
  "extensions.cloud_choose_org": "Choose an organization in your Cloud account to add Library items.",
  "extensions.view_available_mcps": "View available MCPs",
  "extensions.open_cloud_account": "Open Cloud account",
  ...
  "extensions.filter_connections": "Connectors",
  ...
  "extensions.detail_share": "Share",
  "extensions.detail_chat": "Chat",
  "extensions.detail_remove": "Remove",
  "extensions.detail_disconnect": "Disconnect",
  ...
  "extensions.detail_chip_added_by_you": "Added by you",
  "extensions.detail_chip_shared_by_org": "Shared by your organization",
  ...
  "extensions.local_this_workspace": "Local · this workspace",
  "extensions.local_this_device": "Local · this device",
  ...
  "providers.disconnect_unverified": "Disconnection could not be verified. Stored credentials may have been removed, but the provider may still be available. Refresh the provider list before trying again.",
  "providers.disconnected_prefix": "Disconnected",
  "providers.enabled_prefix": "Enabled",
  "providers.enable_failed": "Failed to enable provider",
  ...
  "session.cmd_new_session_title": "New session",
  ...
  "session.admission_outcome_unknown": "Couldn’t confirm whether this finished",
  ...
  "settings.browser_title": "Browser",
  "settings.browser_section_desc": "Control how you browse the web from OpenWork.",
  "settings.links.open_in": "Open links in",
  "settings.links.open_in_desc": "Choose where links open by default. Right-click to choose a different destination.",
  "settings.links.external": "External browser",
  "links.choose_destination": "Where should this link open?",
  "links.dont_ask_again": "Don't ask again",
  "links.open_external": "Open in external browser",
  "links.open_openwork": "Open in OpenWork",
  "links.open_failed": "Could not open this link. Try again.",
  ...
  "settings.auto_update_desc": "Download new versions in the background and install when you quit. You can also restart when you’re ready.",
  ...
  "settings.provider_disabled_badge": "Disconnected",
  "settings.provider_disabled_hint": "Hidden from models and Connect.",
  "settings.enable_provider": "Enable",
  "settings.enabling_provider": "Enabling...",
  ...
  "settings.provider_load_error": "Could not load the provider list or OpenCode configuration. Check the workspace connection and configuration, then retry.",
  "settings.provider_load_incompatible_permissions": "OpenCode V1 does not support the plural \"permissions\" configuration used by V2. Use an engine compatible with these rules or ask your administrator to resolve the mismatch, then retry. Your configuration and permission rules have not been changed.",
  ...
  "settings.providers_not_refreshed": "Showing previously loaded providers. This list has not been refreshed.",
  "settings.providers_retry": "Retry",
  ...
  "settings.update_restart_button": "Restart to update",
  "settings.update_on_quit_hint": "Installs automatically when you quit.",
  ...
  "updates.check_cooldown": "You can check again in a few seconds.",
  "updates.retry": "Retry",
  "updates.bridge_unavailable": "Electron updater bridge is unavailable.",
  "updates.installed_version_unknown": "Could not determine the installed OpenWork version.",
  "updates.release_inventory_invalid": "Den returned an invalid desktop release inventory.",
  "updates.staged_unavailable": "The previously downloaded update is no longer confirmed ready to install. Retry to check for updates, then choose a download.",
  ...
  "skills.title": "Skills",
  "skills.uninstall": "Remove",
  "skills.uninstall_failed": "Failed to remove skill.",
  "skills.uninstall_title": "Remove skill?",
  ...
  "session_management.open_in_split_view": "Open as side chat",
  "session_management.new_split": "Open side chat",
  "session_management.close_split_view": "Close side chat",
  "session_management.split_view": "Side chat",
  "session_management.main_chat": "Main chat",
  "session_management.open_chats": "Open chats",
  "session_management.selected_chat": "Selected",
  "session_management.second_chat_title": "A fresh conversation, right here",
  "session_management.second_chat_description": "Ask something else while keeping your main chat open. Messages from your main chat are not included here.",
  "session_management.second_chat_saved": "Both chats stay saved when you go back to one.",
  "session_management.message_main": "Message main chat",
  "session_management.message_second": "Message second chat",
  "session_management.expand_side_chat": "Open as main chat",
  "session_management.side_chat_hint": "Start a separate conversation beside your current chat.",
  ...
  "session_management.archived_read_only": "This conversation is read-only. Restore it to continue; previous work will not restart.",
  "session_management.restore_session": "Restore",
